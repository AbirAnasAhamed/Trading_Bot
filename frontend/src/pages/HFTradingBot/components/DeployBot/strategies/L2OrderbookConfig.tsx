...
export const L2OrderbookConfig: React.FC<L2OrderbookConfigProps> = memo(({
  ...
  return (
    <div className="space-y-4">
      <h3 className="text-lg font-bold text-white border-b border-panel pb-2">L2 Wallhunter Strategy</h3>
      
      <div className="grid grid-cols-2 gap-4">
        <div className="space-y-1">
          <label className="text-xs font-bold text-gray-400 uppercase tracking-wider">Wall Multiplier</label>
          <div className="relative">
            <input 
              ...
              className="w-full bg-[#0d0f15] border border-panel rounded-lg pl-3 pr-8 py-2 text-white text-sm focus:outline-none focus:border-blue-500 transition-colors"
            />
        ...
        <div className="space-y-1">
          <label className="text-xs font-bold text-gray-400 uppercase tracking-wider">Min Wall Vol (USD)</label>
          <div className="relative">
            <input 
              type="number" 
              step="1000"
